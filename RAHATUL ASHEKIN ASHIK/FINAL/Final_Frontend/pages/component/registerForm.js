...
const RegisterForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Error Manager Register:', error);
  ...
  return (
    <>
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-gray-600/50 to-gray-700/75 rounded-xl 100">
        <div class="flex flex-wrap justify-center">
          <div class="w-80">

            <h3 class="text-center mb-4 text-3xl font-bold text-white">Create Manager</h3>
