...
const UpdateManagerForm = () => {
    ...
    const handleFile = async (e) => {
        ...
        try {
            ...
            alert("Manager Profile Image Upload Successful!")
        } catch (error) {
            console.error('Error Manager File Update:', error);
            alert("Manager Profile Image Upload Failed!");
        }
    }
            ...
            <div class="flex flex-wrap justify-center">
                <div>
                    ...
                    <form onSubmit={handleFile}>
                        ...
                        <center>
                            <button onClick={handleFile} class="text-white bg-green-500 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">UPLOAD</button>
                            <br></br><br></br>
                        </center>
                    </form>
